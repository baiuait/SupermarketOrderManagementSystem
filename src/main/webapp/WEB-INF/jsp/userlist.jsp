...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
			...
			<div class="providerAdd">
				<p><strong>用户编号：</strong><span id="v_userCode"></span></p>
				<p><strong>用户名称：</strong><span id="v_userName"></span></p>
				<p><strong>用户性别：</strong><span id="v_sex"></span></p>
				<p><strong>出生日期：</strong><span id="v_birthday"></span></p>
				<p><strong>用户电话：</strong><span id="v_phone"></span></p>
				<p><strong>用户地址：</strong><span id="v_address"></span></p>
				<p><strong>用户角色：</strong><span id="v_userRoleName"></span></p>
				<p><strong>创建时间：</strong><span id="v_creation"></span></p>
			</div>
        </div>
    </section>
